...
export default function Skills() {
  const [skills] = useState([
    ...
    { id: 8, name: "n8n", icon: <img src="/assets/n8nblog.jpg" alt="n8n" style={{ width: "80px", height: "80px", objectFit: "contain" }} /> },
  ...
  const [experiences] = useState([
    {
      ...
      description:
        "Working as part of a product development team on real-world applications focused on solving practical problems. Contributing to the design and development of innovative solutions aimed at building market-ready products.",
      logo: "https://combosquare.in/assets/img/hero-img.jpg",
    },
  ]);
        ...
        <div className="px-5 lg:px-28 my-8 lg:mt-16 space-y-10">
          {experiences.map((exp, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              onDoubleClick={() => window.open("https://drive.google.com/file/d/1gCTeapl1ex-fRkOW41PkR7XZ7PKK001S/view?usp=sharing", "_blank")}
            >
              <div className="flex justify-between flex-col items-start lg:flex-row lg:items-center">
                <div className="flex items-center gap-5">
                  <img className="w-15 h-10" src={exp.logo} alt="" />
